  ...
  pl: {
    ...
    order: {
      ...
      step2: {
        ...
        photoCommentLabel: 'Uwagi do zdjęcia / Karty / inne',
        ...
        nfcNotesLabel: '📲 Wytyczne do NFC',
        nfcNotesRequired: '(wymagane)',
        nfcNotesPlaceholder: 'Co ma się dziać po zbliżeniu telefonu do karty? np. link do Instagrama, playlisty z imprezy, wizytówki VCard, strony...',
        nfcNotesNote: 'Wybrałeś kartę z NFC — bez tej informacji nie będziemy wiedzieć, co zaprogramować w chipie.',
      ...
      step5: {
        ...
        deliveryCombinedOption: 'Połącz z innym zamówieniem',
        linkedOrderRefLabel: 'Numer poprzedniego zlecenia *',
        linkedOrderRefPlaceholder: 'np. 8f3a2b1c lub cały numer z maila',
        linkedOrderRefNote: 'Tej karcie nie doliczamy wysyłki — wyślemy ją razem z zamówieniem, które podałeś/aś powyżej.',
        ...
        errLinkedOrderRefRequired: 'Podaj numer zamówienia, z którym chcesz połączyć wysyłkę.',
        errPhotoRequired: 'Dodaj zdjęcie, z którego zrobimy Twoją kartę — bez niego nie możemy przygotować projektu.',
        errNfcNotesRequired: 'Wybrałeś kartę z NFC — w kroku 2 podaj wytyczne, co zaprogramować w chipie.',
  ...
  en: {
    ...
    order: {
      ...
      step2: {
        ...
        photoCommentLabel: 'Notes on the photo / card / other',
        optional: '(optional)',
        ...
        nfcNotesLabel: '📲 NFC guidelines',
        nfcNotesRequired: '(required)',
        nfcNotesPlaceholder: "What should happen when a phone is tapped on the card? e.g. a link to Instagram, an event playlist, a VCard contact, a website...",
        nfcNotesNote: "You picked a card with NFC — without this we won't know what to program onto the chip.",
      ...
      step5: {
        ...
        deliveryCombinedOption: 'Combine with another order',
        linkedOrderRefLabel: 'Previous order number *',
        linkedOrderRefPlaceholder: 'e.g. 8f3a2b1c or the full number from the email',
        linkedOrderRefNote: "We won't add shipping to this card — we'll send it together with the order you entered above.",
        ...
        errLinkedOrderRefRequired: 'Please enter the order number you want to combine shipping with.',
        errPhotoRequired: "Add the photo we'll turn into your card — we can't prepare a design without it.",
        errNfcNotesRequired: "You picked a card with NFC — please add guidelines for the chip in step 2.",
