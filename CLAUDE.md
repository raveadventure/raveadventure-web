...
- **Brak automatycznych płatności online na tym etapie — to ŚWIADOMA decyzja**, nie brak czasu na integrację. Płatność następuje dopiero po akceptacji projektu przez klienta, przez BLIK lub przelew na konto — dane do płatności wysyłane są w mailu razem z projektem karty do akceptacji. Nie sugeruj dodawania Stripe/PayU/automatycznych bramek płatności bez wyraźnej prośby — to nie przeoczenie w architekturze.
